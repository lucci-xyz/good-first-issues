...
export function FilterBar({ bounties, filters, onChange }: FilterBarProps) {
  ...
  const availableLabels = useMemo(() => {
    ...
    bounties.forEach(q => q.labels?.forEach(l => labels.add(l)));
  ...
  const availableOwners = useMemo(() => {
    ...
    bounties.forEach(q => q.owner && owners.add(q.owner));
